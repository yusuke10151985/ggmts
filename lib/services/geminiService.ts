...
const getPrompt = (text: string, sourceLang: string, targetLangs: string[], mode: TranslationMode): string => {
  ...
  const modeInstruction = mode === 'summarize'
    ? `Summarize the following text as a hierarchical numbered list.\n\nCRITICAL FORMATTING REQUIREMENTS:\n- You MUST use hierarchical numbering (1., 1.1, 1.2, 2., 2.1, etc.)\n- Main topics: 1., 2., 3., etc.\n- Subtopics: 1.1, 1.2, 2.1, 2.2, etc.\n- Sub-subtopics: 1.1.1, 1.1.2, etc. (if needed)\n- Each number MUST be followed by a period and a space\n- Use only Arabic numerals (1, 2, 3, ...) for all numbers\n- Each item must be concise and clear\n- Maintain logical grouping of related topics\n\nEXAMPLE FORMAT:\n"1. Main topic one"\n"1.1 First subtopic"\n"1.2 Second subtopic"\n"2. Main topic two"\n"2.1 Related point"\n\nIMPORTANT: DO NOT return plain text or bullet points. ALWAYS use hierarchical numbering.\n\nRespond ONLY with a JSON object in this format:\n{\n  "sourceLanguage": "...",\n  "translations": [\n    {\n      "lang": "...",\n      "text": "...",\n      "summary": [\n        "1. Main point one",\n        "1.1 Sub point",\n        "1.2 Another sub point",\n        "2. Main point two"\n      ]\n    }\n  ]\n}\n\nThe summary array MUST contain strings with hierarchical numbering. Each array element is one numbered point.`

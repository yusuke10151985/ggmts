    ...
    <header className="sticky top-0 z-50 bg-card border-b w-full">
      <div className="flex justify-between items-center px-4 py-2 border-t">
        <div className="flex-1 flex items-center gap-6 min-w-0">
          <a href="/" className="text-xl md:text-2xl font-bold text-primary whitespace-nowrap mr-4">Multi Translator GGMTS</a>
          ...
          <div ref={modeDropdownRef} className="relative ml-6">
            <Button
              variant="ghost"
